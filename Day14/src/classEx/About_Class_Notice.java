...
/*
 *  1. 객체지향 언어의 역사
 *  	- 초창기에는 주로 과학실험이나 미사일 발사실험과 같은 모의 실험을 목적으로 사용되었음.
 *  
 *  	- 모의 실험을 위해 실제 세계와 유사한 가상세계를 컴퓨터 속에 구현하고자 노력하였으며,
 *  	  이렇게 노력한 결과로 객체지향이론이 탄생되었다.
 *  
 * 		- 객체지향의 기본 개념은 '실제 세계는 사물(객체)로 이우러져 있으며, 
 * 		  발생하는 모든 사건들은 사물간의 상호작용이라고 한다.
 * 
 * 		- 실제 사물의 속성과 기능을 분석한 다음 데이터와 함수로 정의함으로써 실제 세계를
 ...
 *     - 자바가 1995년에 발표되고 1990년대말 인터넷을 발전과 함께 크게 객체지향 언어로서
 *       자리를 차지하게 되었다.
 * 
 * 		객체 지향 언어
 * 			- 코드의 재사용성이 높다.
 * 			- 신뢰성이 높으며 높은 프로그래밍을 가능하게 한다.
 *			★아주 큰 장점 : 코드의 재사용성이 높고 유지보수가 용이하다. *******************
 *			객체지향의 3대 특징 : 은닉, 상속, 다형성
 *
 *		클래스와 객체의 정의와 용도
 *
 *			클래스 : 객체를 정의해 놓은 것(클래스는 객체의 설계도이다.)
 *					   객체를 생성하는데 사용된다.
 *
 ...
 *							   클래스에서는	public, default  만 사용가능.
 *
 *			- 멤버필드(속초, 변수)
 *			1. 변수, 상수
 *			2. static 변수, 상수 와 instance 변수, 상수로 구성됨.
 *			
 *			- 멤버 메소드
