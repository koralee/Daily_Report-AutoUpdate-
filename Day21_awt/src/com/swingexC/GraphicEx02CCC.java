...
public class GraphicEx02CCC {
	public static void main(String[] args) {
		...
		button.addActionListener(new DrawActionListenerCCC(text1, text2, text3, drawingPanel));
